...
public class ModConfig {
    ...
    public static final ModConfigSpec.DoubleValue BOND_MORNING_KISS_VOICE_VOLUME;
    ...
    public static final ModConfigSpec.BooleanValue BOND_MORNING_KISS_AI_DIALOGUE_CACHE_CONSUME_ON_USE;
    ...
    public static final ModConfigSpec.DoubleValue BOND_EMERGENCY_RESCUE_VOLUME;
    ...
    public static final ModConfigSpec.DoubleValue VOICE_PREVIEW_VOLUME;
