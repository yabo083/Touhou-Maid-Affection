...
public class ModConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue BOND_RANDOM_GIFT_CURATED_POOL_ONLY;
    ...
    public static final ForgeConfigSpec.BooleanValue BOND_EMERGENCY_RESCUE_USE_PERCENTAGE_THRESHOLD;
    public static final ForgeConfigSpec.DoubleValue BOND_EMERGENCY_RESCUE_HEALTH_THRESHOLD_PERCENTAGE;
