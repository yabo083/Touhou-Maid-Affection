...
## 🆕 v1.7.1.2-forge1.20.1 - 残血救护稳定性热修复

- 修复玩家死亡/重生后在同一 MC 日内，残血救护次数被错误补满的问题。
- 修复同一女仆在复活/重建后可重复叠加救护次数的问题（改为按稳定贡献者 ID 去重）。
- 强化 Rescue 状态在 Clone/Respawn 过程中的持久化恢复链路，并补充可选详细刷新日志用于排查。
