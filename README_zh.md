...
此版本整合并正式发布 `1.7.0.5` 阶段完成的新特性。

- ❤️ 羁绊系统拓展：新增羁绊能力与随机赠礼流程，优化锁定标签页表现，并补齐本地化与配置项。
- 🚨 紧急救援重构：完成救援语音链路与界面同步，加入覆盖控制，修复重复充能，并规范救援者身份映射。
- 🛏️ 膝枕稳定性提升：优化躺卧状态切换，增加与其他女仆任务的冲突门控，并新增永恒乌托邦粒子开关。
- 🎛️ 体验细节打磨：统一救援页面视觉规范，调整晨吻行为，提高多交互场景一致性。
- 🔧 发布维护：整理工程与文档，版本提升至 `1.7.1`。
